...
function NavBar() {
  ...
  const handlePDFRequest = () => {
    ...
    const pdfURL = './assets/images/JS_Resume_SE.pdf';
      ...
      <nav className="nav-wrapper">
        <div className="nav-content">
          ...
          <ul>
            ...
            <li>
              <Link activeClass="active" to="proj-exp" smooth spy offset={-100} className="menu-item">Projects</Link>
            </li>
            ...
            <button className="contact-btn" onClick={handlePDFRequest}> Hire Me </button>
